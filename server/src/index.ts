...
const htaccessPath = join(resolve(__dirname, "../.."), ".htaccess");
if (!existsSync(htaccessPath)) {
  try {
    const appRoot = resolve(__dirname, "../..").replace(/\\/g, "/");
    writeFileSync(htaccessPath, [
    ...
    logger.info(".htaccess auto-generated");
  } catch (e: any) {
    logger.warn("Could not write .htaccess", { error: e.message });
  }
}
