...
async function handleChatSSE(res, message, extraFields, history, productId, conversationMode, isVoice, productType) {
    ...
    const { productData, productList } = (0, orders_js_1.detectProductsFromReply)(cleanReply || fullReply, products);
...
exports.chatRouter.post("/", async (req, res) => {
    try {
        ...
        const body = zod_1.z.object({
            ...
            imageMimeType: zod_1.z.string().optional(),
...
exports.chatRouter.post("/voice", upload.single("audio"), async (req, res) => {
    try {
        ...
        await handleChatSSE(res, message, { imageBase64: null, imageMimeType: null, audioBase64, audioMimeType }, history, productId, conversationMode, true, productType);
    }
    catch (err) {
