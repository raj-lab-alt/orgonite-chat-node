...
// Auto-generate .htaccess if missing (for Hostinger Passenger SSE)
const htaccessPath = (0, path_1.join)((0, path_1.resolve)(__dirname, "../.."), ".htaccess");
if (!(0, fs_1.existsSync)(htaccessPath)) {
    try {
        const appRoot = (0, path_1.resolve)(__dirname, "../..").replace(/\\/g, "/");
        (0, fs_1.writeFileSync)(htaccessPath, [
            "# Phusion Passenger configuration",
            "# Auto-generated by server startup",
            "",
        ...
        logger_js_1.logger.info(".htaccess auto-generated");
    }
    catch (e) {
        logger_js_1.logger.warn("Could not write .htaccess", { error: e.message });
    }
}
